...
const hexAdditionSlidePaths = [
    {
        path: "/images/hex addition/hex-add-1.png",
        description: "Write each hex number down with one on top of the other.",
    },
    {
        path: "/images/hex addition/hex-add-2.png",
        description: "3 + A = D.",
    },
    {
        path: "/images/hex addition/hex-add-3.png",
        description:
            "C + C = 18. Place 8 below and carry the 1 to the next column.",
    },
    {
        path: "/images/hex addition/hex-add-4.png",
        description:
            "B + 8 + 1 = 14. Place 4 below and carry the 1 to the next column.",
    },
    {
        path: "/images/hex addition/hex-add-5.png",
        description: "5 + 2 + 1 = 8.",
    },
];

const hexSubtractionSlidePaths = [
    {
        path: "/images/hex subtraction/hex-sub-1.png",
        description: "Write each hex number down with one on top of the other.",
    },
    {
        path: "/images/hex subtraction/hex-sub-2.png",
        description:
            "3 - 5 results in a negative number. Borrow 1 from the left, so B becomes A to get 13 - 5 which equals E.",
    },
    {
        path: "/images/hex subtraction/hex-sub-3.png",
        description:
            "A - E results in a negative number too, but we can't borrow from the 0 to the left. Instead, borrow from the 8 and reduce it and any number between by 1.",
    },
    {
        path: "/images/hex subtraction/hex-sub-4.png",
        description: "1A - E = C.",
    },
    {
        path: "/images/hex subtraction/hex-sub-5.png",
        description: "F - 8 = 7.",
    },
    {
        path: "/images/hex subtraction/hex-sub-6.png",
        description: "7 - 3 = 4.",
    },
];
</script>
